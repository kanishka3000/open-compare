...
Pure comparison logic in `core/` with no Electron, fs or DOM; all I/O at the edges; a thin
composition root. [`docs/architecture.md`](docs/architecture.md) has the source layout, a class
diagram and the runtime flow from clicking Compare to a rendered diff.
